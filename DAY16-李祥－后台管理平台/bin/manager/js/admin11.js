...
$(document).ready(function() {
    ...
    $("#selectAll").on("click", function () {
        //prop专门用于chekbox,radio
        $('#host_data input[type="checkbox"]').prop("checked", true);
        $("#host_data").children().addClass("select");
    })

    //取消功能
    $("#cancelAll").click(function () {
        $("#host_data").children().find('[type="checkbox"]').attr("checked", false);
        $("#host_data").children().removeClass("select");
    })
    ...
    $("#reseverAll").click(
        function () {
            //循环获取checked状态
            $("#host_data").children().find('[type="checkbox"]').each(
                function () {
                    //三元表达式
    ...
    $("#edit_mode").click(
        function () {
            $("#host_data").children().find("[target]").each(
                function () {
                    //获取target和值
                    var target = $(this).attr("target");
                    var value = $(this).text();
    ...
    $("#operation").on("click","#save_mode",
        function () {
            $("#host_data").children().find("input[target]").each(
                function () {
                    var value=$(this).val();
